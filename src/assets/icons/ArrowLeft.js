  ...
  return (
    <View
      ...
      <Svg
        ...
        style={{
          enableBackground: 'enable-background:new 0 0 512.008 512.008',
        }}>
        <Path
          fill={color}
          d="M501.342,245.185H36.424L210.227,71.404c4.093-4.237,3.975-10.99-0.262-15.083
	...
	L36.424,266.519h464.917c5.891,0,10.667-4.776,10.667-10.667S507.233,245.185,501.342,245.185z"
        ...
        <Path
          fill={color}
          d="M202.675,458.519c-2.831,0.005-5.548-1.115-7.552-3.115l-192-192c-4.164-4.165-4.164-10.917,0-15.083l192-192
	...
	c4.171,4.16,4.179,10.914,0.019,15.085C208.224,457.39,205.508,458.518,202.675,458.519z"
        ...
        <Path
          fill={color}
          d="M501.342,266.519H10.675c-5.891,0-10.667-4.776-10.667-10.667s4.776-10.667,10.667-10.667h490.667
